...
export default async function Image({
  ...
  // Safe navigation for variants in case device is undefined
  ...
  return new ImageResponse(
    (
      ...
      >
        <div style={{ fontSize: "24px", color: "#a6adc8", marginBottom: "8px" }}>
          RootDB
        </div>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: "64px", fontWeight: 800, color: scoreColor }}>
              {bestScore}
            </div>
            <div style={{ fontSize: "18px", color: "#a6adc8" }}>Root Score</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontSize: "64px", fontWeight: 800, color: "#a6e3a1" }}>
              {rootable}
            </div>
            <div style={{ fontSize: "18px", color: "#a6adc8" }}>Rootable</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
